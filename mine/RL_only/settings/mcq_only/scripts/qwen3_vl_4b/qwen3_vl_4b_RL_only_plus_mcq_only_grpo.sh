...
export WANDB_NAME="qwen3_vl_4b_rl_only_plus_mcq_only_grpo"
...
python3 -m verl.trainer.main \
    config=mine/RL_only/settings/mcq_only/scripts/qwen3_vl_4b/config.yaml \
    ...
    trainer.experiment_name=qwen3_vl_4b_rl_only_plus_mcq_only_grpo \
